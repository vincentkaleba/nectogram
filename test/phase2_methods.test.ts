...
describe('Phase 2 Methods Test Suite', () => {
  it('should expose all Phase 2 Auth, Account, InviteLinks & Contacts methods on Client.prototype', () => {
    ...
    expect(typeof client.changePhoneNumber).toBe('function')
    expect(typeof client.getActiveSessions).toBe('function')
    expect(typeof client.resetSession).toBe('function')
    expect(typeof client.resetSessions).toBe('function')
    expect(typeof client.sendPhoneNumberCode).toBe('function')
    expect(typeof client.resendPhoneNumberCode).toBe('function')
    ...
    expect(typeof client.getGlobalPrivacySettings).toBe('function')
    expect(typeof client.setGlobalPrivacySettings).toBe('function')
    expect(typeof client.setInactiveSessionTtl).toBe('function')
    expect(typeof client.addProfileAudio).toBe('function')
    expect(typeof client.removeProfileAudio).toBe('function')
    expect(typeof client.setProfileAudioPosition).toBe('function')
